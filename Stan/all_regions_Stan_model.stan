/* current changes:
- removed t_data (=1), D(=S), t0(=0)
- removed p_incubation and p_preclinical (were only used to calculate 
  p_tau_1 and p_tau_2, added those directly)
- removed p_children_trans(=1) and removed contact2 (=contact * p_children_trans)
*/
...
data {
  ...
  // |_ Controls ----
  int  S; 
    // number of days in the period of data collection (not: days passed during
  ...
  real tau_1; // incubation period
  real tau_2; // preclinical period (part of the incubation with possible transmission)
