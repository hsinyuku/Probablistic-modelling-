...
# ----------------------------------------------------------------------------#
initialiseSession <- function(region, type, ind_eta, iterations, chains, 
                              timestamp, visualise, savePlots) {
  # specify here which posterior file you want to load!
  init_controls(list(region = region,
                     type = type,
                     visualise = visualise,
                     savePlots = savePlots,
                     ind_eta = ind_eta,
