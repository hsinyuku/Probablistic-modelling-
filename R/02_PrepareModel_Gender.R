...
data_list_model = {list(
  ...
  gender_dist = gender_dist, # age distribution
  ...
  genderdistr_cases   = genderdistr_cases,   # age distribution of cases
  genderdistr_deaths  = genderdistr_deaths,  # age distribution of deaths
